...
@section('main-content')
            <div class="  authincation h-auto" style=" background-color: #F5F5F5; height: auto;">
                                                        ...
                                                        <a href="{{ route('facebook.login') }}"
                                                            ...
                                                            <span role="img" aria-label="google"
                                                                class="d-flex align-items-center pe-2"><svg viewBox="64 64 896 896"
                                                                    focusable="false" data-icon="google" width="100%"
                                                                    height="20px" fill="currentColor" aria-hidden="true">
                                                                    <path
