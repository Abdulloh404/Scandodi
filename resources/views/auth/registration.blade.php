...
<div class="container" style="display: flexbox;">
    <div class="row justify-content-center align-items-center height-page mt-md-5 py-md-5 mt-0 py-0">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="p-4 bg-white rounded-5 ">
                        ...
                        <form action="{{ route('user.store') }}" method="post" id="signUpForm">
                            ...
                            <input type="hidden" name="restaurant" value="{{ request()->get('restaurant') }}">
                            @endif
                            <div class="form-group">
                                <input type="text" id="name" class="form-control"
                                    placeholder="{{ trans('auth.name_ex') }}" value="{{ old('name') }}" name="name">
                            </div>
                            <div class="form-group">

                                <input type="email" id="email" class="form-control" value="{{ old('email') }}"
                                    placeholder="{{ trans('auth.email_ex') }}" name="email"
                                    onkeydown="function validation()">
                            </div>
                            <div class="form-group">
