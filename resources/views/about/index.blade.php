...
<div class="container-fluid bg-color-about">
    <div class="container p-5 px-xl px-lg px-md px-2 pb-xl-3 pb-lg-3 pb-md-3 pb-0">
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-12 my-xl-auto my-lg-auto my-md mb-0 mx-auto">
            ...
            <div
                class="col-xl-8 col-lg-8 col-md-12 col-12 my-auto py-xl-2 py-lg-2 py-md-0 p-xl-5 p-lg-5 p-md-5 p-3 pb-0">
                <div class="mb-3 wow fadeInRight" data-wow-delay="0.6s">
                    <h1 class="text-gradient">Our Philosophy</h1>
                </div>
                <div class="wow fadeInRight font-size-about" data-wow-delay="0.7s">
                    <p>We are lucky to live in a glorious age that gives us everything we could ask for as a human
                        race. What more could you need when you have meat covered in cheese nestled between bread.
                    </p>
                    <p>From smashed patties at Shake Shack to Glamburgers at Honky Tonk, there’s a little something
                        for everyone. Some burgers are humble, and some are ostentatious, and you just have to try
                        them all to figure out what you want. Feel free to contact us.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="container p-5 px-xl px-lg px-md px-2 pt-0">
        <div class="row">
            <div
                class="col-xl-8 col-lg-8 col-md-12 col-12 my-xl-auto my-lg-auto my-md mb-0 py-xl-2 py-lg-2 py-md-0 p-xl-5 p-lg-5 p-md-5 p-3">
                <div class="mb-3 wow fadeInRight" data-wow-delay="0.4s">
                    <h1 class="text-gradient">Local ingredients</h1>
                </div>
                <div class="wow fadeInRight font-size-about" data-wow-delay="0.5s">
                    <p>Whether you’re a ketchup and mustard loyalist or you prefer house sauce to no sauce, you can
                        agree that every cheeseburger has it’s own special flair. Top tip: house sauce begs to be
                        ordered on the side for fry-dipping purposes.</p>
                </div>
            </div>
...
$(document).on('click', '.signIn', function(e) {
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('{{ json_decode(get_settings('
            site_setting '))->recaptcha_site_key }}', {
                action: 'submit'
            }).then(function(token) {
