...
<body class="h-100">
    ...
    <div class="nav-header">
        <a href="{{ route('dashboard') }}" class="brand-logo">
            <img class="logo-abbr" src="{{ asset('uploads/' . json_decode(get_settings('site_setting'))->logo) }}"
                alt="">
                        ...
                        <ul class="navbar-nav header-right">
                                                    ...
                                                    <div class="timeline-panel">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            @elseif($notification->type == 'order')
                                                                <h6 class="mb-1"><a
                                                                        href="{{ route('order.show') }}">{{ $notification->message }}</a>
                                                                </h6>
                                                            @endif
                                                            <small
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="/comment" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/newsleter" class="dropdown-item ai-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
                                            <path
                                                d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z" />
                                        ...
                                        <span class="ml-2">Subscribes-List</span>
                                    </a>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    {{-- <h4 class="text-center mb-4">{{trans('layout.verify_email')}}</h4> --}}
                                    <form action="{{ route('verification.send') }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label><strong>{{ trans('layout.message.verify_text') }}</strong></label>
                                        </div>
