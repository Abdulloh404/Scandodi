...
@section('main-content')
    ...
    <div class="container" style="display: flexbox;">
        <div class="row justify-content-center align-items-center height-page-login mt-md-5 py-md-5 mt-0 py-0">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="p-4">
                                ...
                                <div class="mb-2">
                                    <div class="d-grid text-center mt-3">
                                        <a href="{{ route('facebook.login') }}"
                                            ...
                                            ?>
                                            <i class="fab fa-facebook-square fa-lg pe-3 text-primary"></i>Sign up with
                                            Facebook
                                        </a>
                                    </div>
                                    <div class="d-grid text-center mt-3">
                            ...
                            <div class="new-account mt-3 text-center ">
                                <p class="m-0">{{ trans('auth.haven\'t_account') }} <a class="text-primary"
